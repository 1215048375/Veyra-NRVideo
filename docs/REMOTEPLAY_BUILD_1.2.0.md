...
The 1.2.0 portable package enables `VEYRA_ENABLE_REMOTEPLAY`. The default build without this option does not include PS5 Remote Play.

Application source: https://github.com/Likely7/Veyra-NRVideo/tree/v1.2.0
