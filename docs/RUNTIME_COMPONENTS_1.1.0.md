# Veyra 1.1.0 Runtime Components
...
Smooth Motion is managed by the user's NVIDIA App and installed driver. Veyra 1.1.0 adds setup instructions and does not bundle a Smooth Motion DLL, write driver settings, or enforce exclusivity with internal DLSS/XeSS generation. Driver-generated work is outside Veyra's measured frame/timing counters.


## PS5 Remote Play in 1.1.0
