...
- [ ] P0.2 确认 .gitignore 后按 LOOP_ENGINE 固定顺序初始化本地 Git；显式 staged allowlist、建立 baseline commit、切到 agent/veyra-v1-loop、写 baselineCommit 状态指针；验证两个二进制、runtime_local、third_party_local、reference_local、captures、logs 均未被跟踪。
