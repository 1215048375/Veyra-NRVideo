...
> 2026-09-10：本手册为历史参考。用户已废弃旧 Loop、控制哈希 preflight 与早期 Phase/R0–R12 强制执行顺序；不得按本文的旧入口阻塞当前修复。当前任务以最新用户指令、AGENTS.md、对应修复计划及 WORKLOG 为准。仍适用的 GPU、颜色、资源生命周期契约继续参考，测试单次不超过 300 秒。
