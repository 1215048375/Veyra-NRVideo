...
$result=[ordered]@{test=$Name;exitCode=$process.ExitCode;seconds=$watch.Elapsed.TotalSeconds;exeHash=(Get-FileHash $Exe -Algorithm SHA256).Hash;args=$TestArgs;inputs=$inputs}
